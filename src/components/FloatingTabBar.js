...
const HIDDEN_ON_SCREENS = ['EventDetail', 'Ticket', 'NotificationCenter', 'ScanConnection', 'ConnectionDetail', 'SocialCard', 'EditSocialLinks', 'PostEventVideo', 'PhotoGallery', 'EventVideoFeed'];
